...
const Navbar = () => {
    ...
    return (
        <Flex className={styles.nav} gap={8}>
...
<a href="https://drive.google.com/file/d/1nfkjAlzCYOGhl7pewaCPymuXSRZ9ylgr/view?usp=share_link" download target='blank'><ImDownload/></a>
